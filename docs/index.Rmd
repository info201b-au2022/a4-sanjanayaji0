...
```{r echo=FALSE, warning = FALSE}
plot_jail_pop_by_states(c("CA"))
```

*Caption: This is a line chart that shows the growth of the U.S. prison population from 1970 to 2018 by one or more states.*

I chose to focus on data from California, as it is my main focus for this data analysis. This chart shows a significant increase in jail population in California, especially from 1970 to 1990. There is then a slight decrease, from 2008 to 2010, and then another increase, followed by a plateau. My main question is: What kind of crimes caused an such an increase in incarceration rates from 1980 to 1990. For example, was there an increase in drug-related crimes, murder, or robberies?
